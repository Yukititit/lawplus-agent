...
async def sum_model(state: any, runtime: any) -> any:
    ...
    Never reveal or include specific internal database identifiers, file names, or index labels (e.g., avoid any output resembling "practice_direction_v202508" or similar).
